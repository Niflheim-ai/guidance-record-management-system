<?php
    ...
    $totalOtherToday = getOtherRecordsCurrentDay($conn);
    $totalOtherRecordMonth = getOtherRecordsCurrentMonth($conn);
    $totalOtherRecordYear = getOtherRecordsCurrentYear($conn);

    deleteOtherRecord($conn);
    ...
    <div class="wrapper">
        ...
        <div class="main" style="margin-left: 70px">
            ...
            <main class="content px-3 py-4">
                <p class="h1 mb-3 fw-bold text-center">Others</p>
                <!-- Statistics Card -->
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-8 mb-4">
                        <div class="card w-100 mx-auto">
                            ...
                            <div class="card-body statistics-body" style="background-color: rgba(244, 246, 107, 0.28)">
                                <p class="fw-bold h1 d-flex justify-content-center align-items-center pt-3"><?php echo $totalOtherToday ?></p>
                            </div>
                            <div class="card-footer">
                                <span class="text-muted d-flex justify-content-center">Total # of Records</span>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-8 mb-4">
                        <div class="card w-100 mx-auto">
                            ...
                            <div class="card-body statistics-body" style="background-color: rgba(244, 246, 107, 0.28)">
                                <p class="fw-bold h1 d-flex justify-content-center align-items-center pt-3"><?php echo $totalOtherRecordMonth ?></p>
                            </div>
                            <div class="card-footer">
                                <span class="text-muted d-flex justify-content-center">Total # of Records</span>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-8 mb-4">
                        <div class="card w-100 mx-auto">
                            ...
                            <div class="card-body statistics-body" style="background-color: rgba(244, 246, 107, 0.28)">
                                <p class="fw-bold h1 d-flex justify-content-center align-items-center pt-3"><?php echo $totalOtherRecordYear ?></p>
                            </div>
                            <div class="card-footer">
                                <span class="text-muted d-flex justify-content-center">Total # of Records</span>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <table id="other-table" class="table table-striped data-table text-center" style="width: 100%">
                                        ...
                                        <tbody>
                                            <tr>
                                                <?php
                                                    while($row = mysqli_fetch_assoc($resultOther)) {
                                                ...
                                                <td><a href="edit-otherRecords.php?record_ID=<?php echo $recordID ?>" type="button" class="btn btn-warning edit-record-btn">Edit</a></td>
                                            </tr>
                                            <?php
                                                }
                                            ?>
                        ...
                        <label for="productName" class="col-4 col-form-label text-black">Record ID</label>
                            <div class="col-8">
                                <select name="record_ID" id="recordID" class="form-select" required="required" placeholder="Select Record ID">
                                    <?php
                                        $selectRecord = "SELECT * FROM others";
