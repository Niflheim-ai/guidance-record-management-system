<?php
    ...
    $totalLeaveRecordYear = getLeaveRecordsCurrentYear($conn);

    deleteLeaveRecord($conn);
...
<body>
    <div class="wrapper">
        ...
        <div class="main" style="margin-left: 70px">
            ...
            <main class="content px-3 py-4">
                <p class="h1 mb-3 fw-bold text-center">Filing Leave of Absence</p>
                <!-- Statistics Card -->
                <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-8 mb-4">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-8 mb-4">
                        <div class="card w-100 mx-auto">
                            ...
                            <div class="card-body statistics-body" style="background-color: rgba(244, 246, 107, 0.28)">
                                <p class="fw-bold h1 d-flex justify-content-center align-items-center pt-3"><?php echo $totalLeaveToday ?></p>
                            </div>
                            <div class="card-footer">
                                <span class="text-muted d-flex justify-content-center">Total # of Records</span>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-8 mb-4">
                        <div class="card w-100 mx-auto">
                            ...
                            <div class="card-body statistics-body" style="background-color: rgba(244, 246, 107, 0.28)">
                                <p class="fw-bold h1 d-flex justify-content-center align-items-center pt-3"><?php echo $totalLeaveRecordMonth ?></p>
                            </div>
                            <div class="card-footer">
                                <span class="text-muted d-flex justify-content-center">Total # of Records</span>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-8 mb-4">
                        <div class="card w-100 mx-auto">
                            ...
                            <div class="card-body statistics-body" style="background-color: rgba(244, 246, 107, 0.28)">
                                <p class="fw-bold h1 d-flex justify-content-center align-items-center pt-3"><?php echo $totalLeaveRecordYear ?></p>
                            </div>
                            <div class="card-footer">
                                <span class="text-muted d-flex justify-content-center">Total # of Records</span>
                            </div>
    ...
    <div class="modal fade" tabindex="-1" id="addRecord">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="modal-title">Add Record - Leave of Absence</h1>
                    <a type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></a>
                </div>
                <div class="modal-body">
    ...
    <div class="modal fade" tabindex="-1" id="deleteRecordModal">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="modal-title">Remove Record - Leave of Absence</h1>
                    <a type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></a>
                </div>
                <div class="modal-body">
                    <form action="#" method="POST" class="form">
                        ...
                        <label for="productName" class="col-4 col-form-label text-black">Record ID</label>
                            <div class="col-8">
                                <select name="record_ID"" class="form-select" required="required" placeholder="Select Record ID">
                                    <?php
                                        $selectRecord = "SELECT * FROM leave_of_absence";
    ...
    <!-- Edit Record Modal -->
    <div class="modal fade editRecordModal" tabindex="-1" id="editRecordModal">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="modal-title">Edit Record - Leave of Absence</h1>
                    <a type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></a>
                </div>
                <div class="modal-body">
                    <form action="#" method="POST" class="form">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#loa-table thead tr')
                .clone(true)
                .addClass('filters')
                .appendTo('#loa-table thead');
        
            var table = $('#loa-table').DataTable({
                orderCellsTop: true,
                fixedHeader: true,
                aLengthMenu: [
                    [10, 20, 50, 100, -1],
