...
<body>
                        ...
                        <div class="card text-center">
                            ...
                            <div class="card-body">
                                <form action="export-pdf.php" method="POST">
                                    <input type="submit" name="exportaaf" class="btn btn-outline-primary d-flex ms-auto mb-3" value="Export as PDF">
                                </form>
    ...
    <div class="modal fade" tabindex="-1" id="addRecord">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="modal-title">Add Record - Absence Approval Form</h1>
                    <a type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></a>
                </div>
                <div class="modal-body">
    ...
    <div class="modal fade" tabindex="-1" id="editRecordModal">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="modal-title">Edit Record - Absence Approval Form</h1>
                    <a type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></a>
                </div>
                <div class="modal-body">
                <form action="#" method="POST" class="form">
