<?php
    ...
    $totalCounsellingToday = getCounsellingRecordsCurrentDay($conn);
    $totalCounsellingRecordMonth = getCounsellingRecordsCurrentMonth($conn);
    $totalCounsellingRecordYear = getCounsellingRecordsCurrentYear($conn);

    deleteCounsellingRecord($conn);
...
<body>
    <div class="wrapper">
        ...
        <div class="main" style="margin-left: 70px">
            ...
            <main class="content px-3 py-4">
                <p class="h1 mb-3 fw-bold text-center">Counselling / Consultation</p>
                <!-- Statistics Card -->
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-8 mb-4">
                        <div class="card w-100 mx-auto">
                            ...
                            <div class="card-body statistics-body" style="background-color: rgba(244, 246, 107, 0.28)">
                                <p class="fw-bold h1 d-flex justify-content-center align-items-center pt-3"><?php echo $totalCounsellingToday ?></p>
                            </div>
                            <div class="card-footer">
                                <span class="text-muted d-flex justify-content-center">Total # of Records</span>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-8 mb-4">
                        <div class="card w-100 mx-auto">
                            ...
                            <div class="card-body statistics-body" style="background-color: rgba(244, 246, 107, 0.28)">
                                <p class="fw-bold h1 d-flex justify-content-center align-items-center pt-3"><?php echo $totalCounsellingRecordMonth ?></p>
                            </div>
                            <div class="card-footer">
                                <span class="text-muted d-flex justify-content-center">Total # of Records</span>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-8 mb-4">
                        <div class="card w-100 mx-auto">
                            ...
                            <div class="card-body statistics-body" style="background-color: rgba(244, 246, 107, 0.28)">
                                <p class="fw-bold h1 d-flex justify-content-center align-items-center pt-3"><?php echo $totalCounsellingRecordYear ?></p>
                            </div>
                            <div class="card-footer">
                                <span class="text-muted d-flex justify-content-center">Total # of Records</span>
                            </div>
                        ...
                        <div class="card text-center">
                            ...
                            <div class="card-body">
                                <form action="export-pdf.php" method="POST">
                                    <input type="submit" name="exportcounselling" class="btn btn-outline-primary d-flex ms-auto mb-3" value="Export as PDF">
                                </form>
                                    ...
                                    <table id="counselling-table" class="table table-striped data-table text-center" style="width: 100%">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <!-- <td><a href="edit-counsellingRecord.php?record_ID=<?php echo $recordID ?>" type="button" class="btn btn-warning edit-record-btn">Edit</a></td> -->
                                            </tr>
                                            <?php
                                                }
                                            ?>
    ...
    <div class="modal fade" tabindex="-1" id="addRecord">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="modal-title">Add Record - Counselling / Consultation</h1>
                    <a type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></a>
                </div>
                <div class="modal-body">
                        ...
                        <label for="productName" class="col-4 col-form-label text-black">Record ID</label>
                            <div class="col-8">
                                <select name="record_ID" id="recordID" class="form-select" required="required" placeholder="Select Record ID">
                                    <?php
                                        $selectRecord = "SELECT * FROM counselling";
    ...
    <?php addCounsellingRecord($conn); ?>

    <script>
        $(document).ready(function () {
            // Setup - add a text input to each footer cell
            $('#counselling-table thead tr')
                .clone(true)
                .addClass('filters')
                .appendTo('#counselling-table thead');
        
            var table = $('#counselling-table').DataTable({
                orderCellsTop: true,
                fixedHeader: true,
                aLengthMenu: [
                    [10, 20, 50, 100, -1],
